...
// @Router /api/teachers/invitations [post]
...
// @Router /api/teachers/invitations/jobs/{job_id} [get]
...
// @Router /api/teachers/invitations/jobs/{job_id}/retry-failed [post]
...
// @Router /api/teachers/invitations/jobs/{job_id}/events [get]
