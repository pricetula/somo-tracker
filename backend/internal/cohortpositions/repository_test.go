...
func TestPgRepository_GetByStudentTerm_NotFound(t *testing.T) {
	if testing.Short() {
...
func TestPgRepository_ListByClassTerm_Empty(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping integration test in short mode")
	}
	ctx := context.Background()
...
func TestPgRepository_ListByGradeTerm_Empty(t *testing.T) {
	if testing.Short() {
		t.Skip("skipping integration test in short mode")
	}
	ctx := context.Background()
