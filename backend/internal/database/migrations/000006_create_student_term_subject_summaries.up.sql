...
-- ============================================================================
-- TRIGGER: trg_assessment_sessions_refresh_summary
-- Fires AFTER UPDATE on assessment_sessions when status changes to PUBLISHED.
-- Calls fn_refresh_term_subject_summary_for_session for the affected session.
-- ============================================================================
...
COMMENT ON TRIGGER trg_assessment_sessions_refresh_summary ON assessment_sessions IS
    'After an assessment session is published, refresh the
     student_term_subject_summaries for all students in that session.';
