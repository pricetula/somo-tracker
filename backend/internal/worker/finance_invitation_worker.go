...
type FinanceInvitationProcessor struct {
	svc       services.FinanceInvitationServiceInterface
	stytchCli *stytch.Client
	logger    *zap.Logger
	redis     RedisPublisher
}

func NewFinanceInvitationProcessor(svc services.FinanceInvitationServiceInterface, cli *stytch.Client, logger *zap.Logger, pub RedisPublisher) *FinanceInvitationProcessor {
	return &FinanceInvitationProcessor{
		svc:       svc,
		stytchCli: cli,
...
// ProcessTask handles "finance:invitation:batch" tasks.
// Processes each item sequentially, updating status and publishing progress.
func (p *FinanceInvitationProcessor) ProcessTask(ctx context.Context, task *asynq.Task) error {
...
func (p *FinanceInvitationProcessor) ProcessRetryTask(ctx context.Context, task *asynq.Task) error {
...
func (p *FinanceInvitationProcessor) processSingleItem(ctx context.Context, jobID, itemID uuid.UUID) {
...
func (p *FinanceInvitationProcessor) handleStytchError(ctx context.Context, jobID, itemID uuid.UUID, attempts int, err error, payload InvitationPayload) {
...
func (p *FinanceInvitationProcessor) deriveJobStatus(ctx context.Context, jobID uuid.UUID) {
...
func (p *FinanceInvitationProcessor) publishProgress(ctx context.Context, jobID uuid.UUID) {
	if p.redis == nil {
		return
	}
