...
type GuardianInvitationProcessor struct {
...
func NewGuardianInvitationProcessor(svc services.GuardianInvitationServiceInterface, cli *stytch.Client, logger *zap.Logger, pub RedisPublisher) *GuardianInvitationProcessor {
	return &GuardianInvitationProcessor{
		svc:       svc,
		stytchCli: cli,
...
// ProcessTask handles "guardian:invitation:batch" tasks.
// Processes each item sequentially, updating status and publishing progress.
func (p *GuardianInvitationProcessor) ProcessTask(ctx context.Context, task *asynq.Task) error {
...
func (p *GuardianInvitationProcessor) ProcessRetryTask(ctx context.Context, task *asynq.Task) error {
...
func (p *GuardianInvitationProcessor) processSingleItem(ctx context.Context, jobID, itemID uuid.UUID) {
...
func (p *GuardianInvitationProcessor) handleStytchError(ctx context.Context, jobID, itemID uuid.UUID, attempts int, err error, payload InvitationPayload) {
...
func (p *GuardianInvitationProcessor) deriveJobStatus(ctx context.Context, jobID uuid.UUID) {
...
func (p *GuardianInvitationProcessor) publishProgress(ctx context.Context, jobID uuid.UUID) {
	if p.redis == nil {
		return
	}
