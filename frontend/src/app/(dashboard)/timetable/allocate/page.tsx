/**
 * Allocate Page — /timetable/allocate
 *
 * Renders the AllocationForm which reads `?block=`, `?class=`, `?day=` from the URL.
 * Wrapped in <Suspense> because the form uses useSearchParams (Next.js requirement).
 */
