/**
 * Invite Form Content — the shared form body used by both dialog and page variants.
 *
 * Manages a dynamic list of invite rows with email, name, and role fields.
 */
...
export interface InviteFormContentProps {
    onSuccess: () => void;
}
...
export function InviteFormContent({ onSuccess }: InviteFormContentProps) {
