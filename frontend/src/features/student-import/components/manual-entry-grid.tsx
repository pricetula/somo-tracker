...
function ParentCombobox({ value, parentsMap, onChange }: ParentComboboxProps) {
...
function ClassCombobox({ value, classesMap, onChange }: ClassComboboxProps) {
...
function ComboboxInput({ placeholder, value, options, onChange }: ComboboxInputProps) {
